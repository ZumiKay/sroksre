    ...
    if (view === "user" && data?.user) {
      return (
        <div className="bg-blue-50 rounded-2xl p-4 space-y-0">
          ...
          <InfoRow
            label="Phone"
            value={(data.user as any).phonenumber ?? undefined}
          />
        </div>
      );
    }
    ...
    if (view === "shipping") {
      return (
        <div className="bg-indigo-50 rounded-2xl p-4 space-y-0">
          ...
          <InfoRow label="House ID" value={String(data.shipping?.houseId)} />
                ...
                <div className="flex flex-col gap-2">
                  {isAdmin && (
                    ...
                    >
                      ...
                      <FontAwesomeIcon
                        icon={faChevronRight}
                        className="text-gray-300 text-xs group-hover:text-blue-400 transition-colors"
                      />
                    </button>
                  )}
                  {data?.shipping && orderdata.shippingtype !== "Pickup" && (
                    ...
                    >
                      ...
                      <FontAwesomeIcon
                        icon={faChevronRight}
                        className="text-gray-300 text-xs group-hover:text-indigo-400 transition-colors"
                      />
                    </button>
                  )}
                </div>
