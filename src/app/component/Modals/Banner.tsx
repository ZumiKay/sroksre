...
export const BannerModal = ({
    ...
    return (
        ...
        >
            <div
                className="bannermodal_content bg-white p-3 relative max-small_phone:rounded-none rounded-lg w-full h-full max-small_phone:min-h-screen overflow-x-hidden  flex flex-col gap-y-5 items-center">
                <div
