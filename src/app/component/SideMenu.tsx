...
export const InfoContainer = (props: infocontainerprops) => {
    return (
        <div
            className="info__container w-[300px] max-w-[400px] h-fit flex flex-col items-start justify-start gap-y-5 p-2 bg-white rounded-lg">
...
export const ConfirmModal = () => {
    ...
    return (
        <Modal closestate={"confirmmodal"} customZIndex={200}>
            <div
                className="confirm_container flex flex-col justify-center items-center gap-y-5 bg-white w-[250px] h-[280px] rounded-md">
...
export const FilterMenu = ({
    ...
    useEffect(() => {
        const fetchpromo = async () => {
            ...
            const data = await ApiRequest({
                url: `/api/promotion?ty=byid&ids=${param.promoids}`,
                method: "GET",
            });
            if (data.success) {
    ...
    return (
        ...
        >
            ...
            <div
                className="filtermenu w-full relative  h-fit bg-white p-5 max-small_phone:max-h-[50vh] rounded-md flex flex-col justify-center gap-y-5">
                {type !== "usermanagement" && (
                    <input
                        type="text"
                        name="name"
...
export const Alertmodal = () => {
    ...
    return (
        <Modal closestate="discount">
            <div
                className="alertmodal_container flex flex-col items-center  gap-y-10 w-fit h-fit min-w-[300px] p-5 bg-white rounded-lg">
